...
class DisconnectReason_Data {
 public:
  static DisconnectReason_Data* New(mojo::internal::Buffer* buf) {
    return new (buf->Allocate(sizeof(DisconnectReason_Data))) DisconnectReason_Data();
  }
 ...
 private:
  DisconnectReason_Data() : header_({sizeof(*this), 0}) {
  }
...
class PeerAssociatedEndpointClosedEvent_Data {
 ...
 private:
  PeerAssociatedEndpointClosedEvent_Data() : header_({sizeof(*this), 0}) {
  }
...
class AssociatedEndpointClosedBeforeSentEvent_Data {
 ...
 private:
  AssociatedEndpointClosedBeforeSentEvent_Data() : header_({sizeof(*this), 0}) {
  }
