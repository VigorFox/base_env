...
struct Serializer<::mojo::pipe_control::DisconnectReasonDataView, MaybeConstUserType> {
  ...
  static size_t PrepareToSerialize(MaybeConstUserType& input,
    ...
    size_t size = sizeof(::mojo::pipe_control::internal::DisconnectReason_Data);
  ...
  static void Serialize(MaybeConstUserType& input,
                        Buffer* buffer,
                        ::mojo::pipe_control::internal::DisconnectReason_Data** output,
                        SerializationContext* context) {
    if (CallIsNullIfExists<Traits>(input)) {
      *output = nullptr;
      return;
    ...
    auto result =
        ::mojo::pipe_control::internal::DisconnectReason_Data::New(buffer);
    ALLOW_UNUSED_LOCAL(result);
...
struct Serializer<::mojo::pipe_control::PeerAssociatedEndpointClosedEventDataView, MaybeConstUserType> {
  ...
  static size_t PrepareToSerialize(MaybeConstUserType& input,
    ...
    decltype(CallWithContext(Traits::disconnect_reason, input, custom_context)) in_disconnect_reason = CallWithContext(Traits::disconnect_reason, input, custom_context);
    size += mojo::internal::PrepareToSerialize<::mojo::pipe_control::DisconnectReasonDataView>(
        in_disconnect_reason, context);
    return size;
  }
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    decltype(CallWithContext(Traits::disconnect_reason, input, custom_context)) in_disconnect_reason = CallWithContext(Traits::disconnect_reason, input, custom_context);
    typename decltype(result->disconnect_reason)::BaseType* disconnect_reason_ptr;
    mojo::internal::Serialize<::mojo::pipe_control::DisconnectReasonDataView>(
        in_disconnect_reason, buffer, &disconnect_reason_ptr, context);
    result->disconnect_reason.Set(disconnect_reason_ptr);
    *output = result;
