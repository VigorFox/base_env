...
static void InitDefaultsSourceAddressToken() {
  ...
  {
    void* ptr = &::net::_SourceAddressToken_default_instance_;
    new (ptr) ::net::SourceAddressToken();
    ::google::protobuf::internal::OnShutdownDestroyMessage(ptr);
  }
  ::net::SourceAddressToken::InitAsDefaultInstance();
}
...
static void InitDefaultsSourceAddressTokens() {
  ...
  {
    void* ptr = &::net::_SourceAddressTokens_default_instance_;
    new (ptr) ::net::SourceAddressTokens();
    ::google::protobuf::internal::OnShutdownDestroyMessage(ptr);
  }
  ::net::SourceAddressTokens::InitAsDefaultInstance();
}
...
void SourceAddressToken::InitAsDefaultInstance() {
  ::net::_SourceAddressToken_default_instance_._instance.get_mutable()->cached_network_parameters_ = const_cast< ::net::CachedNetworkParameters*>(
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::net::SourceAddressToken* Arena::CreateMaybeMessage< ::net::SourceAddressToken >(Arena* arena) {
  return Arena::CreateInternal< ::net::SourceAddressToken >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::net::SourceAddressTokens* Arena::CreateMaybeMessage< ::net::SourceAddressTokens >(Arena* arena) {
  return Arena::CreateInternal< ::net::SourceAddressTokens >(arena);
}
}  // namespace protobuf
}  // namespace google
