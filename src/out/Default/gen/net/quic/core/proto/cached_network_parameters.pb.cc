...
static void InitDefaultsCachedNetworkParameters() {
  ...
  {
    void* ptr = &::net::_CachedNetworkParameters_default_instance_;
    new (ptr) ::net::CachedNetworkParameters();
    ::google::protobuf::internal::OnShutdownDestroyMessage(ptr);
  }
  ::net::CachedNetworkParameters::InitAsDefaultInstance();
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::net::CachedNetworkParameters* Arena::CreateMaybeMessage< ::net::CachedNetworkParameters >(Arena* arena) {
  return Arena::CreateInternal< ::net::CachedNetworkParameters >(arena);
}
}  // namespace protobuf
}  // namespace google
