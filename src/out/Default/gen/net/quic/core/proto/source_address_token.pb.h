...
namespace google {
namespace protobuf {
template<> NET_EXPORT_PRIVATE ::net::SourceAddressToken* Arena::CreateMaybeMessage<::net::SourceAddressToken>(Arena*);
template<> NET_EXPORT_PRIVATE ::net::SourceAddressTokens* Arena::CreateMaybeMessage<::net::SourceAddressTokens>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace net {
...
private:
const ::net::CachedNetworkParameters& _internal_cached_network_parameters() const;
public:
...
inline const ::net::CachedNetworkParameters& SourceAddressToken::_internal_cached_network_parameters() const {
...
auto* p = CreateMaybeMessage<::net::CachedNetworkParameters>(GetArenaNoVirtual());
