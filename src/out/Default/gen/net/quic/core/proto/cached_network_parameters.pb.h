...
namespace google {
namespace protobuf {
template<> NET_EXPORT_PRIVATE ::net::CachedNetworkParameters* Arena::CreateMaybeMessage<::net::CachedNetworkParameters>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace net {
...
class NET_EXPORT_PRIVATE CachedNetworkParameters : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:net.CachedNetworkParameters) */ {
public:
...
template <> struct is_proto_enum< ::net::CachedNetworkParameters_PreviousConnectionState> : ::std::true_type {};
